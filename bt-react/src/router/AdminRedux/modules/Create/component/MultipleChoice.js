...
export default function MultipleChoice({answersByType, setAnswerByType}) {
    console.log(answersByType)
  ...
  //     //   item.exact =false
  //     // }
  //     item.exact  = item.id === itemId
  //   })
  //   answersByType(answersClone)
  // }
    return (
        <>
